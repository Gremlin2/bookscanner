...
{
    public class PublishInfoNode : DocumentNode, IPublishInfoNode
    {
        ...
        public override void Load(XmlElement parentNode)
        {
            ...
            this.bookName = LoadElement(parentNode, "./fb:book-name");
            this.publisher = LoadElement(parentNode, "./fb:publisher");
            this.city = LoadElement(parentNode, "./fb:city");

            string yearValue = LoadElement(parentNode, "./fb:year");
            ...
            this.isbn = LoadElement(parentNode, "./fb:isbn");
